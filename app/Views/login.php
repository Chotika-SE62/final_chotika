...
<body>
  ...
  <ul>
    <nav class="nav navbar-dark bg-dark">
      ...
      <li><a href="\login" class="btn btn-success" style="margin-top:7px; color:white; margin-left:860px;">เข้าสู่ระบบ</a></li>
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-6">
        ...
        <form action="/login/auth" method="post">
          <div class="mb-3">
            <label for="inputemail" class="form-label" style="color:white;">E-mail</label>
  ...
  <footer class="bg-dark text-center text-lg-start" style="margin-top: 200px;;">
